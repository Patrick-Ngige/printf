...
/**
 * print_hex - a function that prints an unsigned int in hexadecimal form
...
/**
 * print_x - a function that takes an unsigned int and prints
...
/**
 * _pow - a function that calculates an exponent
